...
你的直觉可能是要围绕常见的由不同设备分辨率决定的视窗尺寸来编写媒体查询临界点，诸如 320px、 480px、 768px、 1024px、 1224px等等。这是一个糟糕的想法。

当构建一个响应式网站的时候，应该适应一组不同的视窗尺寸，而不是考虑设备。只有当网站布局打乱，看起来奇怪，或者用户体验受到了阻碍的时候，才应该引入一个临界点（也有人翻译为断点）。
